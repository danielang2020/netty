...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    final ChannelFuture initAndRegister() {
        ...
        try {
			// if choose NioServerSocketChannel, then get channel by ReflectiveChannelFactory @danielang
        ...
        channel.eventLoop().execute(new Runnable() {
            ...
            public void run() {
                if (regFuture.isSuccess()) {
					/**
					 * @see io.netty.channel.DefaultChannelPipeline.HeadContext#bind(ChannelHandlerContext, SocketAddress, ChannelPromise)
					 */
